...
export default function ConferencesPage() {
  ...
  const loadConferences = async () => {
    try {
      setIsLoading(true)
      setError(null)
      const data = await fetchConferences(lang, 1, 100)
      console.log("[v0] Conferences loaded:", data.results)
  ...
  const handleImageError = (conference: Conference) => {
    ...
    console.log(`[v0] Conference image failed to load for: ${slug}`)
                  ...
                  {upcomingConferences.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      {upcomingConferences.map((conference) => {
                        ...
                        console.log(`[v0] Conference: ${conference.name}, Slug: ${conferenceSlug}`)
