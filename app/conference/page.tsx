...
export default function ConferencePage() {
  const upcomingConferences = [
    {
      ...
      date: "2024-05-15",
      endDate: "2024-05-17",
      location: "Toshkent, O'zbekiston Milliy Universiteti",
      description:
      ...
      category: "Xalqaro",
      organizer: "O'zbekiston Milliy Universiteti",
    ...
    },
    {
      ...
      date: "2024-06-20",
      endDate: "2024-06-22",
      location: "Samarqand, Samarqand Davlat Universiteti",
      description:
      ...
      status: "Tez orada",
      category: "Milliy",
      organizer: "Samarqand Davlat Universiteti",
    ...
    },
    {
      ...
      date: "2024-07-10",
      endDate: "2024-07-12",
      location: "Buxoro, Buxoro Davlat Universiteti",
      description:
      ...
      category: "Milliy",
      organizer: "Buxoro Davlat Universiteti",
  ...
  const pastConferences = [
    ...
    },
    {
      ...
      date: "2023-09-20",
      endDate: "2023-09-22",
      location: "Xiva, Xorazm Ma'mun akademiyasi",
      description:
      ...
      status: "Yakunlangan",
      category: "Milliy",
      organizer: "Xorazm Ma'mun akademiyasi",
      materials: "Mavjud",
