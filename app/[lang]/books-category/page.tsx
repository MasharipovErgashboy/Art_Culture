...
export default function BookCategoryPage() {
  ...
  useEffect(() => {
    const fetchCategory = async () => {
      ...
      try {
        ...
        if (currentCategoryId && languageChanged) {
          ...
          apiUrl = `https://artculture.pythonanywhere.com/${lang}/book-categories/id/${currentCategoryId}/`
          ...
          apiUrl = `https://artculture.pythonanywhere.com/${lang}/book-categories/${slug}/`
          console.log("[v0] Fetching from:", apiUrl)
        ...
        if (correctSlug && correctSlug !== slug) {
          ...
          console.log("[v0] New URL will be:", `/${lang}/books-category/${correctSlug}`)

          router.replace(`/${lang}/books-category/${correctSlug}`)
        }
    ...
    fetchCategory()
  }, [lang, slug, isLoggedIn, router, currentCategoryId])
